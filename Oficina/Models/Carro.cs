    ...
    public class Carro
    {
        ...
        public Pneu PneuTrazeiroDireito
        {
            ...
            { 
                ...
                pneuTrazeiroDireito = value; 
                    ...
                    Console.WriteLine("TU VAI TROCAR O PNEU COM O CARRO EM MOVIEMNTO?");
            }
        }
        ...
        public void Acelerar(int _impulso)
        {
            ...
            if (Ligado)
            {
                ...
                if(PneuDianteiroDireito.Estourado || PneuDianteiroEsquerdo.Estourado || PneuTrazeiroEsquerdo.Estourado || PneuTrazeiroDireito.Estourado)
                {
                    Frear(VelocidadeAtual);
                }
            }
